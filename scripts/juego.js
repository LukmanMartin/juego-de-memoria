            ...
            if (cartas_pares.length === 0) guardar(this); // this es la carta que tocamos 
                ...
                if (cartas_pares[0] === cartas_pares[2]) {
                    ...
                    if (cartas_abiertas.length === 24) {
                        ...
                        document.getElementById("autor").innerHTML = "Desarrollado por Lukman"
                        //fin juego
                    }
...
const volver = () => {
    document.getElementById(cartas_pares[1]).style.background = "url('img/donde.webp')";
    document.getElementById(cartas_pares[3]).style.background = "url('img/donde.webp')";
    limpiar();
}
